...
namespace HoLLy.dnSpyExtension.Commands.CodeInjection
{
    ...
    internal class InjectRecentMenu : MenuItemBase
    {
        ...
        public InjectRecentMenu(Settings.Settings settings, Lazy<DbgManager> dbgManagerLazy)
        {
    ...
    internal class InjectRecentMenuList : MenuItemBase, IMenuItemProvider
    {
        ...
        [ImportingConstructor]
        public InjectRecentMenuList(Lazy<DbgManager> dbgManagerLazy, ManagedInjector injector, Settings.Settings settings)
        {
            this.dbgManagerLazy = dbgManagerLazy;
